...
public class Const {
    ...
    public static final String URL_GET_FILTER = "http://" + HOST + "/android_register_login/test2.php";
    public static final String URL_REGIST = "http://" + HOST + "/android_register_login/register.php";
